...
namespace ToDo.API.Extensions
{
    ...
    {
        public static async Task LogExceptionAsync(this Serilog.ILogger logger, Exception exception)
        {
        ...
        public static async Task LogMessageAsync(this Serilog.ILogger logger, LogMessage message)
        {
